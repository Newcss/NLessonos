...
CREATE ROLE nlessonsuser;
ALTER ROLE nlessonsuser WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'md53f518480f898b81b0b229e3fbecf07c2';
...
--
-- Name: template1; Type: DATABASE; Schema: -; Owner: nlessonsuser
--

CREATE DATABASE template1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';


ALTER DATABASE template1 OWNER TO nlessonsuser;
...
--
-- Name: DATABASE template1; Type: COMMENT; Schema: -; Owner: nlessonsuser
--
...
--
-- Name: template1; Type: DATABASE PROPERTIES; Schema: -; Owner: nlessonsuser
--
...
--
-- Name: DATABASE template1; Type: ACL; Schema: -; Owner: nlessonsuser
--
...
--
-- Name: nlessonsdb; Type: DATABASE; Schema: -; Owner: nlessonsuser
--

CREATE DATABASE nlessonsdb WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';
